...
import com.sam_chordas.android.stockhawk.service.WidgetRemoteViewService;
...
//            appWidgetManager.notifyAppWidgetViewDataChanged(appWidgetId, R.id.lv_content);
    ...
    private void setRemoteAdapter(Context context, @NonNull final RemoteViews views) {
        views.setRemoteAdapter(R.id.lv_content,
    ...
    private void setRemoteAdapterV11(Context context, @NonNull final RemoteViews views) {
        views.setRemoteAdapter(0, R.id.lv_content,
                new Intent(context, WidgetRemoteViewService.class));
    }
